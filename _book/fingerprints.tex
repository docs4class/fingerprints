...
\hypertarget{gods-fingerprints-in-my-discipline}{%
\chapter{God's Fingerprints in My Discipline}\label{gods-fingerprints-in-my-discipline}}

\hypertarget{when-i-grow-up}{%
\chapter{When I grow up}\label{when-i-grow-up}}
...
\hypertarget{the-ten-commandments-exodus-20-niv}{%
\section{The Ten Commandments, Exodus 20 (NIV)}\label{the-ten-commandments-exodus-20-niv}}
...
\href{https://gobluehose.com/news/2023/2/1/bevy-of-newcomers-join-pc-football-program-on-national-signing-day.aspx}{A non-Beasley-friendly example}
...
\includegraphics{07-final_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\hypertarget{nfl-a-class-room-application}{%
\chapter{NFL, a class room application}\label{nfl-a-class-room-application}}

\hypertarget{real-data}{%
\section{\texorpdfstring{\href{https://github.com/nflverse/nflverse-data/releases/tag/pbp}{Real data}}{Real data}}\label{real-data}}

\hypertarget{chaos}{%
\section{\texorpdfstring{\href{https://www.sportingnews.com/us/nfl/news/nfl-fourth-down-conversion-chart-rate-by-distance/vofkeub6xwms6imajxqkfipp}{Chaos}}{Chaos}}\label{chaos}}

\hypertarget{chaos-explained}{%
\section{\texorpdfstring{\href{https://www.nflfastr.com/articles/field_descriptions.html}{Chaos explained}}{Chaos explained}}\label{chaos-explained}}

\hypertarget{just-one-persons-thoughts}{%
\section{\texorpdfstring{\href{https://rpubs.com/afuecker/727520}{Just one person's thoughts}}{Just one person's thoughts}}\label{just-one-persons-thoughts}}
...
\section{The Beginning, Genesis 1 NIV}\label{the-beginning-genesis-1-niv}}

In the beginning God created the heavens and the earth. Now the earth was formless and empty, darkness was over the surface of the deep, and the Spirit of God was hovering over the waters.

\hypertarget{the-source-of-the-tension-genesis-17}{%
\section{The Source of the tension? Genesis 17}\label{the-source-of-the-tension-genesis-17}}

17 To Adam he said\ldots{}

\textbf{``Cursed is the ground because of you;
...
\hypertarget{my-current-life-verse}{%
\section{My current life verse}\label{my-current-life-verse}}

\hypertarget{the-message-galatations-522-23}{%
\subsection{The Message, Galatations 5:22-23}\label{the-message-galatations-522-23}}
